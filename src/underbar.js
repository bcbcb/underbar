...
(function() {
  ...
  _.some = function(collection, iterator) {
    ...
    // This is the same as checking if not every item is false.
    iterator = iterator || _.identity;
  ...
  _.defaults = function(obj) {
    ...
    _.each(properties, function(item){
      _.each(Object.keys(item), function(key) {
        obj[key] = key in obj ? obj[key] : item[key];
      });
    });
    return obj;
  };
  ...
  _.sortBy = function(collection, iterator) {
    ...
    var ordered = iterated.slice().sort();
    var collectionCopy = collection.slice();

    for (var i = 0; i < collection.length; i++) {
      var index = _.indexOf( iterated, ordered.shift() );
      iterated.splice(index, 1);
      results.push( collectionCopy.splice(index, 1)[0] );
    }
  ...
  _.zip = function() {
    ...
    var largestArrayLength = _.reduce(arguments, function(memo, el) {
  ...
  _.intersection = function() {
    var results = [];
    var counts = {};
    var totalArrays = arguments.length;
